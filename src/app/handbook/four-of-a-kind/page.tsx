        ...
        <article className="space-y-4 text-xs md:text-sm text-gray-600 navy:text-slate-300 leading-relaxed">
          <header className="border-b border-slate-200 navy:border-slate-700 pb-6 mb-8">
            ...
            <p className="text-lg text-slate-600 navy:text-[#9BA1A6]">
              Третья по силе монстр-рука, сокрушающая Фулл-Хаусы и Флеши.
              Разбираем правила составления, важнейшую роль кикера при
              совпадениях и математические шансы на победу.
            </p>
          </header>
          ...
          <section className="bg-white navy:bg-[#1C2541] rounded-2xl shadow-sm border border-slate-200 navy:border-slate-800 p-6 mb-8">
            ...
            <p className="mb-4">
              <strong>Каре (Four of a Kind / Quads)</strong> — это комбинация,
              которая состоит из <strong>четырех карт одного номинала</strong> и
              одной дополнительной пятой карты, называемой{" "}
              <strong>кикером</strong>. Масти четырех основных карт всегда
              уникальны и представляют весь комплект колоды (♠️, ♥️, ♦️, ♣️).
            </p>
            ...
            <div className="bg-slate-100 navy:bg-[#0B132B] rounded-xl p-4 flex flex-col sm:flex-row items-center justify-between gap-4">
              <span className="text-sm font-semibold text-slate-500 navy:text-slate-400">
                Пример (Каре Дам со старшим кикером):
              </span>
              <div className="flex gap-2 text-xl sm:text-2xl font-mono font-bold tracking-wider">
                ...
                <span className="bg-white navy:bg-[#1C2541] px-3 py-1.5 rounded-lg shadow-sm text-red-500 border border-emerald-400 dark:border-cyan-500">
                  A♥️
                </span>
              </div>
            </div>
          ...
          <section className="mb-8">
            <h2 className="text-2xl font-bold text-slate-900 navy:text-white mb-4">
              Когда кикер решает всё
            </h2>
            <p className="mb-4">
              Поскольку итоговая покерная рука всегда формируется ровно из 5
              карт, при составлении Каре свободное пятое место занимает
              **кикер**. В большинстве раздач номинал Каре у игроков отличается,
              но бывают ситуации, когда кикер становится единственным фактором
              победы.
            </p>
            ...
            <div className="p-5 rounded-xl border border-slate-200 navy:border-slate-800 bg-white navy:bg-[#1C2541]">
              <h3 className="font-bold text-amber-700 navy:text-amber-400 mb-2">
                Ситуация: Каре на общем столе (Борде)
              </h3>
              <p className="text-sm mb-3 text-slate-600 navy:text-slate-400">
                Представьте, что на стол вышли карты:{" "}
                <span className="font-mono bg-slate-100 dark:bg-slate-900 p-0.5 rounded">
                  8-8-8-8-K
                </span>
                . У всех игроков автоматически собрано Каре восьмерок.
              </p>
              <ul className="text-sm space-y-2 list-disc pl-5 text-slate-700 navy:text-[#E0E1DD]">
                <li>
                  Если у <strong>Игрока 1</strong> в карманных картах есть{" "}
                  <span className="font-mono font-bold text-red-500">A♦️</span>,
                  его пятикарточная рука:{" "}
                  <span className="font-mono">8-8-8-8-A</span>.
                </li>
                <li>
                  Общий Король (<span className="font-mono">K</span>) со стола
                  вытесняется более сильным Тузом из руки.
                </li>
                <li>
                  <strong>Игрок 1 побеждает</strong>, так как его кикер (Туз)
                  старше общего кикера (Короля) и кикеров других соперников.
                </li>
              </ul>
            </div>
          </section>
          ...
          <section className="mb-8">
            ...
            <ul className="space-y-4 list-none pl-0 text-slate-700 navy:text-[#E0E1DD]">
              <li className="flex gap-3">
                ...
                <span>
                  <strong>Номинал самого Каре:</strong> Если у двух игроков
                  разные Каре (часто встречается в Омахе), побеждает тот, чей
                  номинал выше. Каре Королей (
                  <span className="font-mono text-sm bg-slate-100 navy:bg-[#0B132B] px-1 rounded">
                    K-K-K-K-x
                  </span>
                  ) всегда бьет Каре Дам (
                  <span className="font-mono text-sm bg-slate-100 navy:bg-[#0B132B] px-1 rounded">
                    Q-Q-Q-Q-x
                  </span>
                  ).
              ...
              <li className="flex gap-3">
                ...
                <span>
                  <strong>Старшинство кикера:</strong> Если номинал Каре
                  одинаковый (лежит на доске), выигрывает обладатель самой
                  старшей пятой карты.
                </span>
              </li>
              <li className="flex gap-3">
                ...
                <span>
                  <strong>Полное равенство (Chop-Chop):</strong> Если Каре на
                  доске, а у оставшихся в игре соперников карманные карты младше
                  пятой карты стола, то кикером для всех становится карта борда.
          ...
          <section className="mb-8">
            ...
            <p className="mb-4">
              Вероятность получить четыре карты одного достоинства крайне мала,
              что делает Каре практически гарантированным залогом победы в
              раздаче:
            </p>
                ...
                <tbody className="divide-y divide-slate-200 navy:divide-slate-800">
                  <tr>
                    <td className="p-4 font-medium">
                      Общая вероятность собрать Каре на ривере (из 7 доступных
                      карт)
                    </td>
                  ...
                  <tr>
                    <td className="p-4 font-medium">
                      Поймать Каре на флопе, имея карманную пару (например, J-J)
                    </td>
                    <td className="p-4 text-emerald-600 navy:text-cyan-400 font-bold">
                      0.25% (2 аута)
                    </td>
                  ...
                  <tr>
                    <td className="p-4 font-medium">
                      Усилить Тройку (Сет) с флопа до Каре к моменту ривера
                    </td>
                    <td className="p-4 text-emerald-600 navy:text-cyan-400 font-bold">
                      ~4.3%
                    </td>
          ...
          <footer className="p-6 rounded-2xl bg-emerald-50 navy:bg-[#1C2541] border border-emerald-200 navy:border-cyan-900/50">
            <h3 className="text-lg font-bold text-emerald-900 navy:text-cyan-400 mb-2">
              💡 Совет школы покера: Опасность Бад-Бита (Bad Beat)
            </h3>
            <p className="text-sm text-emerald-950 navy:text-slate-300">
              Собрать Каре — заветная мечта, но помните о существовании
              «Бад-Бита», когда ваша сильнейшая рука проигрывает еще более
              редкой комбинации (Стрит-Флешу или более высокому Каре). Если у
              вас Каре на руках (например, вы держите{" "}
              <span className="font-mono">9-9</span> на борде{" "}
              <span className="font-mono">9-9-10-J-Q</span>), будьте внимательны
              к агрессии соперника. Наличие на столе потенциальных Стрит-Флешей
              требует взвешенных решений, хотя в 99.9% случаев вы заберете банк.
              Многие покер-румы выплачивают огромный накопительный Bad Beat
              Jackpot игрокам, проигравшим с комбинацией от Каре валетов и
              старше.
            </p>
          </footer>
        </article>
