      ...
      <div className="w-full max-w-3xl bg-white dark:bg-[#161625] navy:bg-[#121224] p-6 rounded-2xl shadow-lg border border-gray-200 dark:border-gray-800 navy:border-slate-800">
        ...
        <header className="mb-8 flex items-center justify-between border-b pb-4 border-gray-100 dark:border-gray-900/60 navy:border-slate-900/60">
          <div>
            ...
            <p className="text-xs text-gray-400 mt-0.5">Выберите дисциплину для изучения регламента</p>
          </div>
          <Link href="/" className="text-sm font-bold text-[#e94560] hover:underline">◀ Главное меню</Link>
        </header>
          ...
          {pokerGames.map((game, index) => (
            ...
            >
              <div className="max-w-xl">
                <h2 className="text-lg font-bold mb-1 group-hover:text-[#e94560] transition-colors">{game.title}</h2>
                <p className="text-xs text-gray-400 dark:text-gray-400 navy:text-slate-400 leading-relaxed">{game.desc}</p>
              </div>
