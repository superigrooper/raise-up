        ...
        <article className="space-y-4 text-xs md:text-sm text-gray-600 navy:text-slate-300 leading-relaxed">
          <header className="border-b border-slate-200 navy:border-slate-700 pb-6 mb-8">
            ...
            <p className="text-lg text-slate-600 navy:text-[#9BA1A6]">
              Классика дохолдемной эпохи. Узнайте, как играть без общих карт,
              зачем нужен Бринг-ин и как правильно использовать открытую
          ...
          <section className="bg-white navy:bg-[#1C2541] rounded-2xl shadow-sm border border-slate-200 navy:border-slate-800 p-6 mb-8">
            ...
            <p className="mb-4">
              В отличие от Холдема и Омахи, в Стаде{" "}
              <strong>нет общих карт на столе</strong>. Каждому игроку на
              протяжении раздачи сдается индивидуальный набор из{" "}
              <strong>7 карт</strong>: часть из них видны только владельцу
              (закрытые), а часть лежат лицом вверх (открытые) для всего стола.
            </p>
            <div className="p-4 rounded-xl bg-slate-100 navy:bg-[#0B132B] text-sm border-l-4 border-emerald-500">
              <strong>Правило пяти карт:</strong> Из 7 полученных карт к моменту
              финального вскрытия вам нужно выбрать 5, которые образуют
              наилучшую стандартную комбинацию. Позиция дилера (Баттон) в Стаде
              отсутствует; порядок ходов меняется каждую улицу.
            </div>
          </section>
          ...
          <section className="mb-8">
            ...
            <p className="mb-4">
              Игровой процесс в Стаде делится на строго регламентированные
              раунды:
            </p>
            ...
            <div className="space-y-4">
              ...
              <div className="p-5 rounded-xl border border-slate-200 navy:border-slate-800 bg-white navy:bg-[#1C2541]">
                <h3 className="font-bold text-slate-900 navy:text-white mb-1">
                  3-я улица (Старт раздачи)
                </h3>
                <p className="text-sm text-slate-600 navy:text-slate-400 mb-2">
                  Все игроки ставят обязательную небольшую ставку —{" "}
                  <strong>Анте (Ante)</strong>. Дилер сдает каждому по{" "}
                  <strong>3 карты</strong>: две в закрытую (рубашкой вверх) и
                  одну в открытую (лицом вверх).
                </p>
                <div className="p-3 rounded-lg bg-amber-50 navy:bg-amber-950/20 text-xs text-amber-900 navy:text-amber-200">
                  <strong>Специфика торгов (Бринг-ин):</strong> Игрок с самой{" "}
                  <strong>младшей открытой картой</strong> обязан сделать
                  вынужденную ставку — <strong>Бринг-ин (Bring-in)</strong>.
                  Если номиналы равны, младший определяется по масти (от слабой
                  к сильной: трефы ♣️, бубны ♦️, черви ♥️, пики ♠️). Далее торги
              ...
              <div className="p-5 rounded-xl border border-slate-200 navy:border-slate-800 bg-white navy:bg-[#1C2541]">
                <h3 className="font-bold text-slate-900 navy:text-white mb-1">
                  4-я, 5-я и 6-я улицы (Развитие руки)
                </h3>
                <p className="text-sm text-slate-600 navy:text-slate-400">
                  В каждом из этих раундов дилер сдает оставшимся в игре
                  участникам по <strong>одной открытой карте</strong>. После
                  каждой новой карты проводятся торги.
                  <br />
                  <span className="inline-block mt-2 italic font-semibold text-emerald-600 navy:text-cyan-400">
                    Важно: Начиная с 4-й улицы, первым всегда ходит тот игрок, у
                    которого открытые карты на столе образуют самую сильную
                    комбинацию.
                  </span>
                </p>
              </div>
              ...
              <div className="p-5 rounded-xl border border-slate-200 navy:border-slate-800 bg-white navy:bg-[#1C2541]">
                <h3 className="font-bold text-slate-900 navy:text-white mb-1">
                  7-я улица (Финальный аккорд)
                </h3>
                <p className="text-sm text-slate-600 navy:text-slate-400">
                  Каждому сдается последняя, **седьмая карта в закрытую**.
                  Игроки проводят финальный раунд торгов и переходят к шоудауну
                  (вскрытию). В итоге у каждого на руках: 3 закрытых и 4
                  открытых карты.
                </p>
              </div>
            </div>
          ...
          <section className="mb-8">
            <h2 className="text-2xl font-bold text-slate-900 navy:text-white mb-4">
              Лимитная структура ставок (Fixed Limit)
            </h2>
            <p className="mb-4">
              В 7-карточный Стад чаще всего играют с фиксированным лимитом
              ставок. Ставки привязаны к размеру стола (например, лимит
              $10/$20):
            </p>
            ...
            <div className="overflow-x-auto border border-slate-200 navy:border-slate-800 rounded-xl mb-4">
              <table className="w-full border-collapse text-left bg-white navy:bg-[#1C2541] text-sm">
                ...
                <tbody className="divide-y divide-slate-200 navy:divide-slate-800">
                  <tr>
                    <td className="p-4 font-bold text-slate-900 navy:text-white">
                      3-я и 4-я улицы
                    </td>
                    <td className="p-4 text-slate-600 navy:text-slate-300">
                      Все ставки и рейзы должны быть равны **малой ставке**
                      лимита (в нашем примере — строго $10).
                    </td>
                  </tr>
                  <tr>
                    <td className="p-4 font-bold text-slate-900 navy:text-white">
                    ...
                    <td className="p-4 text-slate-600 navy:text-slate-300">
                      Шаг торгов удваивается и становится равен **большой
                      ставке** лимита (строго $20 за шаг).
                    </td>
                  </tr>
                  <tr>
                    <td className="p-4 font-bold text-slate-900 navy:text-white">
                    ...
                    <td className="p-4 text-slate-600 navy:text-slate-300">
                      В каждом раунде торгов разрешено сделать не более 1 ставки
                      и 3 повышений (рейзов). После этого торги «капуются», и
                      игроки могут только коллировать или пасовать.
                    </td>
                  </tr>
                </tbody>
              </table>
          ...
          <footer className="p-6 rounded-2xl bg-emerald-50 navy:bg-[#1C2541] border border-emerald-200 navy:border-cyan-900/50">
            <h3 className="text-lg font-bold text-emerald-900 navy:text-cyan-400 mb-2">
              💡 Ключевой навык для победы в Стаде: Внимательность
            </h3>
            <p className="text-sm text-emerald-950 navy:text-slate-300">
              Главный секрет профессиональной игры в Стад — это **подсчет
              «мертвых» карт**. Вы обязаны внимательно следить за открытыми
              картами всех соперников за столом, особенно за теми, кто
              сбрасывает руки в пас. Например, если вам для сбора Флеша нужна
              пиковая карта, а вы видите, что три пиковые карты уже были открыты
              у сбросивших карты игроков, вероятность закрыть ваше дро резко
              падает. Игрок, умеющий запоминать вышедшие из игры карты, получает
              колоссальное математическое преимущество.
            </p>
          </footer>
        </article>
      </div>
