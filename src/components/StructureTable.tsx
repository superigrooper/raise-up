              ...
              >
                {row.isBreak ? (
                  ...
                  <>
                    ...
                    <td className="p-3 text-gray-400 dark:text-gray-500 navy:text-slate-500">{row.duration} м</td>
                    <td className="p-3">{row.sb}</td>
                    <td className="p-3">{row.bb}</td>
                    <td className="p-3 text-yellow-600 dark:text-yellow-600/80 navy:text-amber-500/80">{row.ante || '—'}</td>
                  </>
                )}
              </tr>
            );
